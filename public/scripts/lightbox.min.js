    ...
    (n = [
              ...
              if (c)
                for (const b of Object.keys(a)) {
                  ...
                  for (const _ of Object.keys(g))
                    _.includes(f) &&
                      x(h, d, p, (u = g[_]).callable, u.delegationSelector);
                }
              for (const v of Object.keys(l)) {
                var m = v.replace(y, "");
                (s && !e.includes(m)) ||
                  x(t, a, r, (m = l[v]).callable, m.delegationSelector);
              }
            }
          },
          trigger(t, e, n) {
          ...
          return e === d.w
            ...
            : O(
                ...
                "rtl" === Object(m.a)(c || l).direction &&
                  (s += Object(_.a)(l.clientWidth, c ? c.clientWidth : 0) - i),
                {
                  width: i,
                  height: u,
                  x: s,
        ...
        class j extends p.a {
          ...
          dispose() {
            clearTimeout(this._timeout),
              h.a.off(this._element.closest(x), C, this._hideModalHandler),
          ...
          _setListeners() {
              ...
              "click" === n
                ...
                : "manual" !== n &&
                  ...
                  h.a.on(this._element, t, this._config.selector, (t) => {
                    ...
                    (e._activeTrigger["focusin" === t.type ? E : S] = !0),
                      e._enter();
                  }),
                  h.a.on(this._element, e, this._config.selector, (t) => {
                    var e = this._initializeOnDelegatedTarget(t);
                    (e._activeTrigger["focusout" === t.type ? E : S] =
            ...
            (this._hideModalHandler = () => {
              ...
              h.a.on(this._element.closest(x), C, this._hideModalHandler);
          }
          _fixTitle() {
            ...
            o =
              (h &&
                ...
                (i = Object(y.a)(o)) === Object(w.a)(o) &&
                  ((i = Object(O.a)(o)),
                  "static" !== Object(x.a)(i).position) &&
                  "absolute" === c &&
                  ((n = "scrollHeight"), (e = "scrollWidth")),
                (s !== v.u && ((s !== v.l && s !== v.s) || a !== v.k)) ||
                  ((b = v.i),
                  (f =
                    (f -
                      ((t && i === _ && _.visualViewport
                        ? _.visualViewport.height
                        : i[n]) -
                        r.height)) *
                    (u ? 1 : -1))),
                (s !== v.l && ((s !== v.u && s !== v.i) || a !== v.k)) ||
                  ((m = v.s),
                  (p =
                    (p -
                      ((t && i === _ && _.visualViewport
            ...
            t =
              !0 === d
                ? ((s = (n = {
                  ...
                  {
                    x: Object(C.c)(s * a) / a || 0,
                    y: Object(C.c)(n * a) / a || 0,
                  })
                : {
                    x: p,
                    y: f,
        ...
        if (o("RegExp", v)) {
          function P(t, e) {
            var n,
              ...
              a = [],
              l = t;
            if (!o && r && s && t.constructor === P) return t;
            if (
              ((r || h(C, t)) && ((t = t.source), s) && (e = f(l)),
              (t = void 0 === t ? "" : p(t)),
              (e = void 0 === e ? "" : p(e)),
              (l = t),
              (r = e =
                y && "dotAll" in j && (n = !!e && -1 < T(e, "s"))
                  ? A(e, /s/g, "")
                  : e),
              I &&
                "sticky" in j &&
          ...
          for (var M = r(x), D = 0; M.length > D; ) a(P, x, M[D++]);
            ...
            if (!h.modifiersData[t]._skip) {
              for (
                    ...
                    return t.concat(
                      Object(A.a)(e) === I.d
                        ? ((n = h),
                          ...
                          (a = t.flipVariations),
                          (l =
                            void 0 === (t = t.allowedAutoPlacements) ? I.o : t),
                          (c = Object(L.a)(i)),
                          (t = c
                            ? a
                              ? I.v
                ...
                var y = a[v],
                  ...
                  x = x ? (O ? I.s : I.l) : O ? I.i : I.u,
                  O = (l[C] > c[C] && (x = k(x)), k(x)),
                  C = [];
                if (
                  (i && C.push(S[w] <= 0),
                  o && C.push(S[x] <= 0, S[O] <= 0),
                  C.every(function (t) {
                    return t;
                  }))
                ) {
            ...
            w &&
              (d &&
                ...
                (b =
                  c +
                  n -
                  (r = null != (i = null == C ? void 0 : C[v]) ? i : 0) -
                  m),
                (s = c + o - r),
                (l = Object(T.a)(
                  _ ? Object(D.b)(e, b) : e,
              ...
              p &&
                ...
                (s = null != (e = null == C ? void 0 : C[y]) ? e : 0),
                (a = b ? o : m - O[i] - x[i] - s + h.altAxis),
                (l = b ? m + O[i] + x[i] - s - h.altAxis : r),
                (c =
                  _ && b
                    ? Object(T.b)(a, m, l)
                    : Object(T.a)(_ ? a : o, m, _ ? l : r)),
                (w[y] = c),
                (S[y] = c - m)),
              (u.modifiersData[t] = S));
          },
      ...
      function (t, e, n) {
        ...
        class y {
          ...
          _getNotchData() {
            (this._notchMiddle = a.a.findOne(_, this._element)),
      ...
      function (t, e, n) {
        ...
        function y(t, e) {
          o[e] = setTimeout(function () {
            return (
              t.isAlive && t.element.classList.remove(_.state.scrolling(e))
            );
        ...
        function w(t) {
          var e = t.element,
            ...
            i =
              ...
              e.contains(t.scrollbarXRail) ||
                (u(e, _.element.rail("x")).forEach(s),
                e.appendChild(t.scrollbarXRail)),
              e.contains(t.scrollbarYRail) ||
                (u(e, _.element.rail("y")).forEach(s),
          ...
          n.isRtl
            ...
            t.scrollbarYActive
              ...
              : (e.classList.remove(_.state.active("y")),
        ...
        function x(n, t) {
          ...
          function m() {
            y(n, c),
              n[u].classList.remove(_.state.clicking),
      ...
      function (t, e, n) {
        ...
        p.forEach((t) => {
          r.b.one(document, "mousedown", t, v.autoInitial(new v()));
        }),
          Object(l.h)(() => {
            const t = Object(l.e)();
            if (t) {
              const e = t.fn[o];
              (t.fn[o] = v.jQueryInterface),
                (t.fn[o].Constructor = v),
                (t.fn[o].noConflict = () => ((t.fn[o] = e), v.jQueryInterface));
            }
          }),
          (e.a = v);
      },
      ...
      function (t, e, n) {
        ...
        var f = n(22),
          ...
          s = n(166),
          n = n(167),
          v = r("native-string-replace", String.prototype.replace),
      ...
      function (R, t, e) {
        ...
        class M {
          constructor(t, e) {
            (this._element = t),
              ...
              (this._dropdownContainerId = Object(d.d)(
          ...
          get optionsList() {
            return r.a.findOne(T, this._dropdownContainer);
          }
          get optionsWrapper() {
            return r.a.findOne(
          ...
          _initOutlineInput() {
            var t = r.a.findOne(j, this._wrapper);
            new s.a(t).init();
          }
          ...
          _appendFakeValue() {
            ...
            this._selectionModel.selection &&
              ...
              (this._fakeValue =
                ...
                e)),
              r.a.findOne(j, this._wrapper).appendChild(this._fakeValue));
          }
          _updateLabelPosition() {
            ...
            this._label &&
              (t && (e || this._isOpen || this._isFakeValueActive)
                ? h.a.addClass(this._label, I)
                : h.a.removeClass(this._label, I));
          }
            ...
            this._fakeValue &&
              ("" === this._input.value && "" !== this._fakeValue.innerHTML
                ? ((this._isFakeValueActive = !0),
                  h.a.addClass(this._fakeValue, I))
                : ((this._isFakeValueActive = !1),
                  h.a.removeClass(this._fakeValue, I)));
          }
          ...
          _updateOptionsListTemplate(t) {
            var e =
                r.a.findOne(T, this._dropdownContainer) ||
        ...
        r.a.find(".select").forEach((t) => {
          ...
          Object(d.h)(() => {
            if (D) {
              const t = D.fn[x];
              (D.fn[x] = M.jQueryInterface),
                (D.fn[x].Constructor = M),
                (D.fn[x].noConflict = () => ((D.fn[x] = t), M.jQueryInterface));
            }
          });
      },
      function (t, e, n) {
      ...
      function (t, e, n) {
        var i = n(14),
          ...
          n = (t.exports = function (t, e, n) {
            ...
            return (
              s(n, "source") ||
                (n.source = m(_, "string" == typeof e ? e : "")),
              t
            );
          });
        ...
        t.exports = function (t, e, n, i, o, r, s) {
          ...
          if (
            ...
            if (
              ...
              for (c in l) (!j && !u && c in h) || S(h, c, l[c]);
            else
              m(
                {
                  target: e,
      ...
      function (t, e, n) {
        ...
        function r(t) {
          l.postMessage(S(t), s.protocol + "//" + s.host);
        }
        var s,
          a,
          l = n(16),
      ...
      function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          ...
          if (p) r = t.iterator;
            ...
            if (O(n)) {
              for (s = 0, a = x(t); s < a; s++)
                if ((l = o(t[s])) && C(T, l)) return l;
              return new b(!1);
            }
            r = S(t, n);
          }
          for (c = (p ? t : r).next; !(u = v(c, r)).done; ) {
            try {
              l = o(u.value);
            } catch (t) {
              k(r, "throw", t);
            }
            if ("object" == typeof l && l && C(T, l)) return l;
          }
          return new b(!1);
        };
      },
        ...
        F(
          D,
          {
            ...
            delete: function (t) {
              ...
              for (
                var e = A(this), n = e.entries, i = y(t), o = 0;
                o < n.length;

              )
                n[o].key === i ? at(n, o, 1) : o++;
            ...
            getAll: function (t) {
              x(arguments.length, 1);
              for (
                var e = A(this).entries, n = y(t), i = [], o = 0;
                o < e.length;
                o++
              )
                e[o].key === n && I(i, e[o].value);
              return i;
            },
            has: function (t) {
              x(arguments.length, 1);
          ...
          !f &&
            ...
            (((L.constructor = m =
              function (t) {
                return (
                  b(this, L),
                  new T(t, 1 < arguments.length ? l(arguments[1]) : {})
                );
              }).prototype = L),
            c(
              {
      ...
      function (t, e, n) {
        ...
        n.a.find('[data-mdb-toggle="tooltip"]').forEach((t) => {
          ...
          Object(i.h)(() => {
            ...
            if (t) {
              const e = t.fn[s];
              (t.fn[s] = _.jQueryInterface),
                (t.fn[s].Constructor = _),
                (t.fn[s].noConflict = () => ((t.fn[s] = e), _.jQueryInterface));
            }
          }),
          (e.a = _);
      },
      ...
      function (t, e, n) {
        "use strict";
        n(11), n(12), n(254), n(262), n(199), n(28), n(200), n(19);
        var i = n(109),
          o = n(3),
          r = n(133),
          s = n(10),
        ...
        class k {
          ...
          _isAllCollapsed() {
            return (
              0 ===
              f.a.find(y, this._element).filter((t) => Object(o.g)(t)).length
            );
          }
          _setup() {
            this._setupTouch(),
      ...
      function (R, t, e) {
        ...
        l.a.on(document, v, '[data-mdb-toggle="modal"]', function (t) {
          ...
          Object(a.a)(O);
        h = O;
        const X = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
          U = ".sticky-top";
        const x = (t, n) => {
        ...
        const A = ".".concat("modal-content"),
          ...
          $ = ".".concat("modal-bottom-right"),
          V = ".".concat("modal-bottom-left"),
          K = ".".concat("modal-top-right"),
          G = ".".concat("modal-top-left"),
          Z = ".".concat("modal-dialog-scrollable"),
          Q = ".".concat("modal-dialog");
        e = "mousedown".concat(v).concat(".data-api");
        const T = "show".concat(v),
          j = "shown".concat(v),
          L = "hidden".concat(v),
          I = "hide.bs.modal",
        ...
        class D extends h {
          ...
          _onModalShown() {
            o.b.on(this._element, j, () => {
              ...
              (this._isScrollable = i.a.findOne(Z, this._element)),
                (this._isBottomRight = i.a.findOne($, this._element)),
                (this._isBottomLeft = i.a.findOne(V, this._element)),
                (this._isTopRight = i.a.findOne(K, this._element)),
                (this._isTopLeft = i.a.findOne(G, this._element)),
          ...
          _removeNonInvasiveClass() {
            i.a.findOne(
              ".".concat("modal", ".").concat("show", ".").concat(k),
              document.body
            )
          ...
          static jQueryInterface(n, i) {
            return this.each(function () {
              let t = r.a.getData(this, S);
              var e = {
                ...M,
                ...s.a.getDataAttributes(this),
                ...("object" == typeof n && n ? n : {}),
              };
              if (((t = t || new D(this, e)), "string" == typeof n)) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "'.concat(n, '"'));
                t[n](i);
        ...
        o.b.on(document, e, '[data-mdb-toggle="modal"]', function (t) {
          ...
          Object(n.h)(() => {
            ...
            if (t) {
              const e = t.fn[C];
              (t.fn[C] = D.jQueryInterface),
                (t.fn[C].Constructor = D),
                (t.fn[C].noConflict = () => ((t.fn[C] = e), D.jQueryInterface));
            }
          });
        t.a = D;
      },
      function (t, e, n) {
        ...
        class C extends n {
          ...
          static jQueryInterface(n, i) {
            return this.each(function () {
              ...
              if (
                (t || !/dispose/.test(n)) &&
                ((t = t || new C(this, e)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "'.concat(n, '"'));
                t[n](i);
        ...
        a.a.find(".fixed-action-btn").forEach((t) => {
          ...
          Object(i.h)(() => {
            ...
            if (t) {
              const e = t.fn[p];
              (t.fn[p] = C.jQueryInterface),
                (t.fn[p].Constructor = C),
                (t.fn[p].noConflict = () => ((t.fn[p] = e), C.jQueryInterface));
            }
          });
        e.a = C;
      },
      function (t, e, n) {
        ...
        class w extends n {
          ...
          dispose() {
            o.b.off(this.element, h),
              o.b.off(this.element, d),
              o.b.off(this.element, p),
              o.b.off(this.element, f),
              o.b.off(this.element, g),
              super.dispose();
          }
          static get NAME() {
            return u;
        ...
        r.a.find('[data-mdb-toggle="popover"]').forEach((t) => {
          ...
          Object(i.h)(() => {
            ...
            if (t) {
              const e = t.fn[u];
              (t.fn[u] = w.jQueryInterface),
                (t.fn[u].Constructor = w),
                (t.fn[u].noConflict = () => ((t.fn[u] = e), w.jQueryInterface));
            }
          });
        e.a = w;
      },
      function (t, e, n) {
        ...
        o.b.on(window, n, () => {
          r.a.find('[data-mdb-spy="scroll"]').forEach((t) => {
            ...
            e || new S(t, s.a.getDataAttributes(t));
          });
        }),
          Object(i.h)(() => {
            const t = Object(i.e)();
            if (t) {
              const e = t.fn[v];
              (t.fn[v] = S.jQueryInterface),
                (t.fn[v].Constructor = S),
                (t.fn[v].noConflict = () => ((t.fn[v] = e), S.jQueryInterface));
            }
          });
        e.a = S;
      },
      function (t, e, n) {
        ...
        o.a
          ...
          Object(i.h)(() => {
            ...
            if (t) {
              const e = t.fn.tab;
              (t.fn.tab = j.jQueryInterface),
                (t.fn.tab.Constructor = j),
                (t.fn.tab.noConflict = () => (
                  (t.fn.tab = e), j.jQueryInterface
                ));
            }
          });
        e.a = j;
      ...
      function (R, t, e) {
        ...
        var n = e(3),
          ...
          o = e(2),
          r = e(1),
          s = (e(11), e(12), e(73), e(28), e(19), e(71)),
          a = e(140),
          l = e(4),
          c = e(6),
          u = e(34),
        ...
        const y = "show",
          ...
          O = "".concat(w, ".").concat(y),
          x = ".dropdown-menu",
          C = Object(l.m)() ? "top-end" : "top-start",
          S = Object(l.m)() ? "top-start" : "top-end",
            ...
            return e.classList.contains("dropend")
              ...
              : ((t =
                  ...
                  getComputedStyle(this._menu)
                    ...
                    .trim()),
                e.classList.contains("dropup") ? (t ? S : C) : t ? B : N);
          }
          _detectNavbar() {
        ...
        c.a.on(document, v, w, E.dataApiKeydownHandler),
          c.a.on(document, v, x, E.dataApiKeydownHandler),
        ...
        class D extends p {
          ...
          dispose() {
            i.b.off(this._element, j),
              i.b.off(this._parent, L),
              i.b.off(this._parent, A),
              i.b.off(this._parent, T),
              super.dispose();
          }
          static get NAME() {
            return k;
          ...
          _dropdownAnimationStart(t) {
            "show" === t
              ? (this._menu.classList.add(I, P), this._menu.classList.remove(M))
              : (this._menu.classList.add(I, M),
                this._menu.classList.remove(P)),
              this._bindAnimationEnd();
          }
          _bindAnimationEnd() {
            i.b.one(this._menu, "animationend", () => {
              this._menu.classList.remove(I, M, P);
            });
          }
        }
        o.a.find('[data-mdb-toggle="dropdown"]').forEach((t) => {
          ...
          Object(n.h)(() => {
            ...
            if (t) {
              const e = t.fn[k];
              (t.fn[k] = D.jQueryInterface),
                (t.fn[k].Constructor = D),
                (t.fn[k].noConflict = () => ((t.fn[k] = e), D.jQueryInterface));
            }
          });
        t.a = D;
      },
      function (t, e, n) {
        ...
        class x extends h {
          ...
          dispose() {
            o.b.off(this._element, v),
              o.b.off(this._element, y),
              super.dispose();
          }
          get verticalOffset() {
        ...
        s.a.find(".alert").forEach((t) => {
          ...
          Object(i.h)(() => {
            ...
            if (t) {
              const e = t.fn[m];
              (t.fn[m] = x.jQueryInterface),
                (t.fn[m].Constructor = x),
                (t.fn[m].noConflict = () => ((t.fn[m] = e), x.jQueryInterface));
            }
          });
        e.a = x;
      },
          ...
          _setupDisplay() {
            this._element.classList.contains("show") ||
              ...
              o.b.on(this._element, k, () => {
                o.b.trigger(this._element, "show.mdb.toast"),
                  this._setupAlignment(),
                  r.a.style(this._element, {
                    display: "block",
                  });
            ...
            Q.r(e),
              function (t, e) {
                    ...
                    (j = S.Prism =
                      {
                        ...
                        disableWorkerMessageHandler:
                          S.Prism && S.Prism.disableWorkerMessageHandler,
                        util: {
                          encode: function (t) {
                            return t instanceof o
                              ? new o(t.type, j.util.encode(t.content), t.alias)
                              : "Array" === j.util.type(t)
                              ? t.map(j.util.encode)
                              : t
                                  .replace(/&/g, "&amp;")
                          ...
                          clone: function (t, n) {
                            ...
                            switch (((n = n || {}), e)) {
                              case "Object":
                                if (n[j.util.objId(t)])
                                  return n[j.util.objId(t)];
                                var i,
                                  o = {};
                                for (i in ((n[j.util.objId(t)] = o), t))
                                  t.hasOwnProperty(i) &&
                                    (o[i] = j.util.clone(t[i], n));
                                return o;
                              case "Array":
                                return n[j.util.objId(t)]
                                  ? n[j.util.objId(t)]
                        ...
                        languages: {
                          ...
                          insertBefore: function (n, t, e, i) {
                            ...
                            return (
                              j.languages.DFS(j.languages, function (t, e) {
                                e === i[n] && t != n && (this[t] = a);
                              }),
                              (i[n] = a)
                            );
                          ...
                          DFS: function (t, e, n, i) {
                            for (var o in ((i = i || {}), t))
                              t.hasOwnProperty(o) &&
                                (e.call(t, o, t[o], n || o),
                                "Object" !== j.util.type(t[o]) ||
                                i[j.util.objId(t[o])]
                                  ? "Array" !== j.util.type(t[o]) ||
                                    i[j.util.objId(t[o])] ||
                                    ((i[j.util.objId(t[o])] = !0),
                                    j.languages.DFS(t[o], e, o, i))
                                  : ((i[j.util.objId(t[o])] = !0),
                                    j.languages.DFS(t[o], e, null, i)));
                          },
                        },
                        plugins: {},
                        highlightAll: function (t, e) {
                          j.highlightAllUnder(document, t, e);
                        },
                        highlightAllUnder: function (t, e, n) {
                          for (
                            var i,
                              ...
                              r =
                                (j.hooks.run("before-highlightall", o),
                                o.elements || t.querySelectorAll(o.selector)),
                              s = 0;
                            (i = r[s++]);

                          )
                            j.highlightElement(i, !0 === e, o.callback);
                        },
                        highlightElement: function (t, e, n) {
                          ...
                          j.hooks.run("before-sanity-check", s),
                            s.code && s.grammar
                              ? (j.hooks.run("before-highlight", s),
                                e && S.Worker
                                  ? (((r = new Worker(j.filename)).onmessage =
                                      function (t) {
                                        (s.highlightedCode = t.data),
                                          j.hooks.run("before-insert", s),
                                          (s.element.innerHTML =
                                            s.highlightedCode),
                                          n && n.call(s.element),
                                          j.hooks.run("after-highlight", s),
                                          j.hooks.run("complete", s);
                                      }),
                                    r.postMessage(
                                      JSON.stringify({
                                        language: s.language,
                        ...
                        highlight: function (t, e, n) {
                          return (
                            ...
                            (t.tokens = j.tokenize(t.code, t.grammar)),
                            j.hooks.run("after-tokenize", t),
                            o.stringify(j.util.encode(t.tokens), t.language)
                          );
                        },
                        ...
                        tokenize: function (t, e, n) {
                          ...
                          return j.matchGrammar(t, i, e, 0, 0, !1), i;
                        },
                        hooks: {
                          all: {},
                          add: function (t, e) {
                        ...
                        S.addEventListener(
                          ...
                          function (t) {
                            var e = (t = JSON.parse(t.data)).language,
                              n = t.code,
                              t = t.immediateClose;
                            S.postMessage(j.highlight(n, j.languages[e], e)),
                              t && S.close();
                          },
                          !1
                        ),
                ...
                if (
                  ...
                  (v = (s = E).util.clone(s.languages.javascript)),
                  (N = /(?:\s|\/\/.*(?!.)|\/\*(?:[^*]|\*(?!\/))\*\/)/.source),
                  (B = /(?:\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])*\})/.source),
                  (n = k(
                    (n = /(?:\{<S>*\.{3}(?:[^{}]|<BRACES>)*\})/.source)
                  ).source),
                  (s.languages.jsx = s.languages.extend("markup", v)),
                  ...
                  (s.languages.jsx.tag.inside.tag.inside["class-name"] =
                    /^[A-Z]\w*(?:\.[A-Z]\w*)*$/),
                  (s.languages.jsx.tag.inside.comment = v.comment),
                  ...
                  (g = I((b = "class enum interface record struct"))),
                  (r = RegExp(I(e + " " + b + " " + v + " " + C))),
                  (v = I(b + " " + v + " " + C)),
                  (e = I(e + " " + b + " " + C)),
                  (b = L(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2)),
                  ...
                  (i.languages.csharp = i.languages.extend("clike", {
                    ...
                    "class-name": [
                      ...
                      {
                        pattern: T(/(\busing\s+)<<0>>(?=\s*=)/.source, [f]),
                        lookbehind: !0,
                      },
                      {
                        pattern: T(/(\b<<0>>\s+)<<1>>/.source, [g, c]),
                        lookbehind: !0,
                        inside: d,
                      },
                      {
                        pattern: T(/(\bcatch\s*\(\s*)<<0>>/.source, [v]),
                        lookbehind: !0,
                        inside: d,
                      },
                      {
                        pattern: T(/(\bwhere\s+)<<0>>/.source, [f]),
                        lookbehind: !0,
                      },
                      {
                  ...
                  i.languages.insertBefore("csharp", "class-name", {
                    ...
                    "constructor-invocation": {
                      pattern: T(/(\bnew\s+)<<0>>(?=\s*[[({])/.source, [u]),
                      lookbehind: !0,
                      inside: d,
                      alias: "class-name",
                    },
                    "generic-method": {
                      pattern: T(/<<0>>\s*<<1>>(?=\s*\()/.source, [f, b]),
                      inside: {
                        function: T(/^<<0>>/.source, [f]),
                        generic: {
                          pattern: RegExp(b),
                          alias: "class-name",
                          inside: d,
                    ...
                    "type-list": {
                      pattern: T(
                        /\b((?:<<0>>\s+<<1>>|record\s+<<1>>\s*<<5>>|where\s+<<2>>)\s*:\s*)(?:<<3>>|<<4>>|<<1>>\s*<<5>>|<<6>>)(?:\s*,\s*(?:<<3>>|<<4>>|<<6>>))*(?=\s*(?:where|[{;]|=>|$))/
                          .source,
                        [g, c, f, u, r.source, C, /\bnew\s*\(\s*\)/.source]
                      ),
                      lookbehind: !0,
                      inside: {
                        "record-arguments": {
                  ...
                  i.languages.insertBefore("csharp", "class-name", {
                    attribute: {
                      ...
                      inside: {
                        target: {
                          pattern: T(/^<<0>>(?=\s*:)/.source, [g]),
                          alias: "keyword",
                        },
                        "attribute-arguments": {
                          pattern: T(/\(<<0>>*\)/.source, [b]),
                          inside: i.languages.csharp,
                        },
                        "class-name": {
                          pattern: RegExp(v),
                    ...
                    E.hooks.add("complete", function (t) {
                      ...
                      t.code &&
                        ...
                        (t.element.querySelector(".line-numbers-rows") ||
                          ...
                          (n = (n = t.code.match(F)) ? n.length + 1 : 1),
                    ...
                    D = function (t, e, n, i) {
                      ...
                      (n =
                        ...
                        "string" != typeof t && (t = t.lang),
                          D.byLanguages[t] || (D.byLanguages[t] = []),
                          D.byLanguages[t].indexOf(o) < 0 &&
                            D.byLanguages[t].push(o);
                      }),
                        (D.byType[t] = this);
                    };
                  for (q in ((D.prototype.init = function () {
                    this._elt ||
                  ...
                  (D.prototype.isDisabled = function (t) {
                    do {
                  ...
                  (D.byLanguages = {}),
                  (D.byType = {}),
                  (D.initEvents = function (t, e) {
                    var n = [];
                    D.byLanguages[e] && (n = n.concat(D.byLanguages[e])),
                      D.byLanguages["*"] && (n = n.concat(D.byLanguages["*"])),
                      t.addEventListener(
                        "mouseover",
                        function (t) {
                          var e = t.target;
                  ...
                  E.hooks.add("after-highlight", function (t) {
                    (D.byLanguages["*"] || D.byLanguages[t.language]) &&
                      D.initEvents(t.element, t.language);
                  }),
                  M))
                    M[q].create();
                }
                ...
                (y =
                  ...
                  "undefined" != typeof self &&
                    ...
                    self.document &&
                    (E.plugins.toolbar
                      ? ((w = (w = window.ClipboardJS || void 0) || Q(117)),
                        (O = []),
                        w ||
      ...
      function (R, N, t) {
        ...
        var n,
          ...
          C = t.f,
          Z = C,
          Q = !!(O && O.createEvent && p.dispatchEvent),
                  ...
                  o &&
                    ...
                    f(g, p, function () {
                      ...
                      if (
                        n &&
                        ((n = $(function () {
                          d ? x.emit("unhandledRejection", e, t) : L(S, t, e);
                        })),
                        (i.rejection = d || I(i) ? A : k),
                        n.error)
                      )
                        throw n.value;
                    }));
          ...
          L = function (t, e, n) {
            ...
            Q
              ...
              !K && (e = p["on" + t])
                ? e(i)
                : t === S && q("Unhandled promise rejection", n);
          },
          I = function (t) {
              ...
              try {
                ...
                i
                  ? l(function () {
                      ...
                      try {
                        f(i, t, P(D, e, n), P(M, e, n));
                      } catch (t) {
                        M(e, t, n);
                      }
                    })
                  : ((n.value = t), (n.state = E), j(n, !1));
              } catch (t) {
                M(
                  {
                    done: !1,
      ...
      function (t, e, n) {
        ...
        h ||
          ...
          (a = function () {
            var t, e;
            for (b && (t = v.domain) && t.exit(); (e = s.get()); )
              try {
                e();
              } catch (t) {
                throw (s.head && l(), t);
      ...
      function (f, g, t) {
        ...
        function u(t) {
          var e, n, i, o;
          if ("number" == typeof t) {
            for (e = [], n = 0; n < 4; n++) rt(e, t % 256), (t = Q(t / 256));
            return A(e, ".");
          }
            ...
            ((r.prototype = {
                      ...
                      if (!k(ut, o)) {
                        if (
                          ...
                          if ("" != u) {
                            ...
                            (a.port =
                              a.isSpecial() && b === P[a.scheme] ? null : b),
                              (u = "");
                          }
                          if (e) return;
                          l = R;
              ...
              setPort: function (t) {
                this.cannotHaveUsernamePasswordPort() ||
                  ("" == (t = C(t)) ? (this.port = null) : this.parse(t, Pt));
              },
              ...
              setPathname: function (t) {
                this.cannotBeABaseURL || ((this.path = []), this.parse(t, R));
              },
              getSearch: function () {
                var t = this.query;
                return t ? "?" + t : "";
        ...
        i &&
          ...
          t &&
            ((l = t.createObjectURL),
            (n = t.revokeObjectURL),
            l && s(d, "createObjectURL", F(l, t)),
            n) &&
            s(d, "revokeObjectURL", F(n, t)),
          q(d, "URL"),
          m(
            {
              global: !0,
      ...
      function (t, e, n) {
        ...
        t.exports = function (t) {
          var e,
            ...
            h = 0;
          if (!l || (this === O && m(l)))
            for (e = _(a), n = t ? new this(e) : O(e); h < e; h++)
              (s = u ? c(a[h], h) : a[h]), v(n, h, s);
          else
            for (
              ...
              (s = u ? g(o, c, [i.value, h], !0) : i.value), v(n, h, s);
          return (n.length = h), n;
        };
      },
      function (t, e, n) {
      ...
      function (t, e, n) {
        ...
        function r(t) {
          var e,
            ...
            r = 0,
            s = 72;
          for (u = 0; u < t.length; u++) (e = t[u]) < 128 && j(n, k(e));
          var a = n.length,
            l = a;
          for (a && j(n, "-"); l < i; ) {
            for (var c = _, u = 0; u < t.length; u++)
              o <= (e = t[u]) && e < c && (c = e);
            var h = l + 1;
            if (c - o > E((_ - r) / h)) throw S(x);
            for (r += (c - o) * h, o = c, u = 0; u < t.length; u++) {
              if ((e = t[u]) < o && ++r > _) throw S(x);
              if (e == o) {
                for (var d = r, p = v; ; ) {
      ...
      function (t, e, n) {
        ...
        n(
          ...
          {
            hypot: function (t, e) {
              for (var n, i, o = 0, r = 0, s = arguments.length, a = 0; r < s; )
                a < (n = l(arguments[r++]))
                  ? ((o = o * (i = a / n) * i + 1), (a = n))
                  : (o += 0 < n ? (i = n / a) * i : n);
              return a === 1 / 0 ? 1 / 0 : a * c(o);
            },
          }
        );
      },
      function (t, e, n) {
        ...
        const s = "lightbox",
          c = "mdb.lightbox",
          u = "lightbox",
          h = "lightbox-gallery-caption",
          d = "fontawesome-pro",
          p = ".".concat(u, " img:not(.lightbox-disabled)"),
          f = {
            container: "string",
        ...
        class m {
          ...
          get currentImg() {
            return r.a.findOne(".active", this._galleryContent);
          }
          get options() {
            var t = {
              ...g,
              ...l.a.getDataAttributes(this._element),
              ...this._options,
            };
            return Object(a.i)(s, t, f), t;
          }
          init() {
          ...
          zoomIn() {
            3 <= this._zoom ||
              ...
              l.a.style(this.currentImg.parentNode, {
          ...
          toggleFullscreen() {
            !1 === this._fullscreen
              ? (l.a.addClass(this._fullscreenBtn, "active"),
                this._gallery.requestFullscreen &&
                  this._gallery.requestFullscreen(),
                (this._fullscreen = !0))
              : (l.a.removeClass(this._fullscreenBtn, "active"),
          ...
          dispose() {
            i.b.off(document, "click", p, this.toggle),
          ...
          _getImages() {
            var t = r.a
              .find("img", this._element)
              .filter((t) => !t.classList.contains("lightbox-disabled"));
            this._images = t;
          }
          _getContainer() {
            this._container = r.a.findOne(this.options.container);
          }
          _setActiveImg(t) {
            this._activeImg =
              "number" == typeof t ? t : this._images.indexOf(t.target);
          }
          _appendTemplate() {
            (this._gallery = Object(a.b)("div")),
              l.a.addClass(this._gallery, "lightbox-gallery"),
          ...
          _appendToolbar() {
            (this._galleryToolbar = Object(a.b)("div")),
              (this._imgCounter = Object(a.b)("p")),
              (this._fullscreenBtn = Object(a.b)("button")),
              (this._zoomBtn = Object(a.b)("button"));
            var t = Object(a.b)("div"),
              e = Object(a.b)("div"),
              n = Object(a.b)("button");
            l.a.addClass(this._galleryToolbar, "lightbox-gallery-toolbar"),
              l.a.addClass(this._imgCounter, "lightbox-gallery-counter"),
              l.a.addClass(
                this._fullscreenBtn,
                "lightbox-gallery-fullscreen-btn"
              ),
              l.a.addClass(this._zoomBtn, "lightbox-gallery-zoom-btn"),
              l.a.addClass(t, "lightbox-gallery-left-tools"),
              l.a.addClass(e, "lightbox-gallery-right-tools"),
              l.a.addClass(n, "lightbox-gallery-close-btn"),
              "pro" === this.options.fontAwesome &&
                (l.a.addClass(this._fullscreenBtn, d),
                l.a.addClass(this._zoomBtn, d),
                l.a.addClass(n, d)),
              ...
              i.b.on(this._fullscreenBtn, "click", () =>
                this.toggleFullscreen()
              ),
              i.b.on(this._zoomBtn, "click", () => this._toggleZoom()),
              i.b.on(n, "click", () => this.close()),
          ...
          _appendContent() {
            (this._galleryContent = Object(a.b)("div")),
              l.a.addClass(this._galleryContent, "lightbox-gallery-content"),
              this._gallery.append(this._galleryContent);
          }
          _appendLoader() {
            this._loader = Object(a.b)("div");
            var t = Object(a.b)("div"),
              e = Object(a.b)("span");
            l.a.addClass(this._loader, "lightbox-gallery-loader"),
              l.a.addClass(t, "spinner-grow"),
              l.a.addClass(t, "text-light"),
              l.a.addClass(e, "sr-only"),
          ...
          _appendCaption() {
            var t = Object(a.b)("div"),
              e = Object(a.b)("p");
            l.a.addClass(t, "lightbox-gallery-caption-wrapper"),
              l.a.addClass(e, h),
              t.append(e),
          ...
          async _loadImages() {
            ...
            let s = 0;
            return (
              this._images.forEach((i, o) => {
                t.push(
                  new Promise((t) => {
                    var e = new Image(),
                      n = Object(a.b)("div");
                    l.a.addClass(n, "lightbox-gallery-image"),
                      this._addImgStyles(e, n, s, o, i),
                      n.append(e),
                      this._galleryContent.append(n),
                      (e.onload = t),
                      (e.src = i.dataset.mdbImg || i.src),
                      r.push(e),
                      (s += 100);
                  })
                );
          ...
          _addImgStyles(t, e, n, i, o) {
            (t.alt = o.alt),
              ...
              (!o.dataset.mdbCaption && "" !== o.dataset.mdbCaption) ||
                (t.dataset.caption = o.dataset.mdbCaption),
              0 === n
                ? (t.width < t.height && l.a.addClass(t, "vertical"),
                  l.a.style(e, {
                    opacity: 1,
                  }),
                  l.a.addClass(t, "active"))
                : l.a.removeClass(t, "active"),
          ...
          _calculateImgSize(t) {
            t.width >= t.height
              ? ((t.style.width = "100%"),
                ...
                (t.style.height = "auto"),
                (t.style.top = "".concat(
                  (t.parentNode.offsetHeight - t.height) / 2,
                  "px"
                )),
                (t.style.left = 0))
              : ((t.style.height = "100%"),
                ...
                (t.style.width = "auto"),
                (t.style.left = "".concat(
                  (t.parentNode.offsetWidth - t.width) / 2,
                  "px"
                )),
                (t.style.top = 0)),
              t.width >= t.parentNode.offsetWidth &&
                ((t.style.width = "".concat(t.parentNode.offsetWidth, "px")),
                (t.style.height = "auto"),
                (t.style.left = 0),
                (t.style.top = "".concat(
                  (t.parentNode.offsetHeight - t.height) / 2,
              ...
              t.height >= t.parentNode.offsetHeight &&
                ((t.style.height = "".concat(t.parentNode.offsetHeight, "px")),
                (t.style.width = "auto"),
                (t.style.top = 0),
                (t.style.left = "".concat(
                  (t.parentNode.offsetWidth - t.width) / 2,
          ...
          _onResize() {
            (this._images = r.a.find("img", this._galleryContent)),
          ...
          _slideHorizontally(n) {
            (this._images = r.a.find("img", this._galleryContent)),
              this._images.forEach((t) => {
                let e;
                "right" === n
                  ? (e = parseInt(t.parentNode.style.left, 10) - 100) < -100 &&
                    (e = 100 * (this._images.length - 2))
                  : (e = parseInt(t.parentNode.style.left, 10) + 100) ===
                      100 * (this._images.length - 1) && (e = -100),
                  this._slideImg(t, e);
              }),
          ...
          _slideToTarget(t) {
            ("first" === t && 0 === this._activeImg) ||
              ("last" === t && this._activeImg === this._images.length - 1) ||
              (this.reset(),
              this._removeEvents(),
              this._showLoader(),
              this._getImages(),
          ...
          _updateCounter() {
            this._images.length <= 1 ||
              setTimeout(() => {
                this._imgCounter.innerHTML = ""
                  .concat(this._activeImg + 1, " / ")
                  .concat(this._images.length);
              }, 200);
          }
          _updateCaption() {
            setTimeout(() => {
              ...
              (!this.currentImg.dataset.caption &&
                ...
                (r.a.findOne(".".concat(h), this._gallery).innerHTML = t);
            }, 200);
          }
          _toggleTemplate() {
          ...
          _updateZoomBtn() {
            1 < this._zoom
              ? (l.a.addClass(this._zoomBtn, "active"),
                this._zoomBtn.setAttribute("aria-label", "Zoom out"))
              : (l.a.removeClass(this._zoomBtn, "active"),
                this._zoomBtn.setAttribute("aria-label", "Zoom in"));
          }
          _updateImgPosition() {
          ...
          _addEvents() {
            var t = r.a.find("img", this._galleryContent);
            (this._onWindowTouchmove = this._onWindowTouchmove.bind(this)),
              ...
              t.forEach((t) => {
                i.b.on(t, "mousedown", this._onImgMousedown, {
                  passive: !0,
                }),
                  i.b.on(t, "touchstart", this._onImgMousedown, {
                    passive: !0,
                  }),
                  i.b.on(t, "mousemove", this._onImgMousemove, {
                    passive: !0,
                  }),
                  i.b.on(t, "touchmove", this._onImgMousemove, {
                    passive: !0,
                  }),
                  i.b.on(t, "wheel", this._onImgWheel, {
                    passive: !0,
                  }),
                  i.b.on(t, "dblclick", this._onImgDoubleClick, {
                    passive: !0,
                  });
              }),
              ...
              i.b.on(window, "touchstart", this._onWindowTouchstart),
              i.b.on(window, "mouseup", this._onImgMouseup),
              i.b.on(window, "touchend", this._onImgTouchend),
              i.b.on(window, "resize", this._onWindowResize),
              i.b.on(window, "orientationchange", this._onWindowResize),
              i.b.on(window, "keyup", this._onKeyupEvent),
              i.b.on(
                window,
                "fullscreenchange",
                this._onWindowFullscreenChange
              ),
              i.b.on(this._gallery, "mousemove", this._onAnyImgAction),
              i.b.on(this._gallery, "click", this._onGalleryClick),
              i.b.on(
                this._rightArrow,
                "keydown",
                this._onRightArrowKeydownEvent
          ...
          _removeEvents() {
            r.a.find("img", this._galleryContent).forEach((t) => {
              i.b.off(t, "mousedown", this._onImgMousedown),
                i.b.off(t, "touchstart", this._onImgMousedown),
                i.b.off(t, "mousemove", this._onImgMousemove),
                i.b.off(t, "touchmove", this._onImgMousemove),
                i.b.off(t, "wheel", this._onImgWheel),
                i.b.off(t, "dblclick", this._onImgDoubleClick);
            }),
              document.removeEventListener(
                "touchmove",
                this._onWindowTouchmove,
                {
                  passive: !1,
                }
              ),
              i.b.off(window, "touchstart", this._onWindowTouchstart),
              i.b.off(window, "mouseup", this._onImgMouseup),
              i.b.off(window, "touchend", this._onImgTouchend),
              i.b.off(window, "resize", this._onWindowResize),
              i.b.off(window, "orientationchange", this._onWindowResize),
              i.b.off(window, "keyup", this._onKeyupEvent),
              i.b.off(
                window,
                "fullscreenchange",
                this._onWindowFullscreenChange
              ),
              i.b.off(this._gallery, "mousemove", this._onAnyImgAction),
              i.b.off(this._gallery, "click", this._onGalleryClick),
              i.b.off(
                this._rightArrow,
                "keydown",
                this._onRightArrowKeydownEvent
          ...
          _onMousemove(t) {
            var e, n;
            this._mousedown &&
              ((n = ((e = t.touches) ? e[0] : t).clientX),
              (t = (e ? e[0] : t).clientY),
              e && this._resetToolsToggler(),
              this._multitouch ||
                (1 !== this._zoom
                  ? ((this._positionX =
                      n * (1 / this._zoom) - this._mousedownPositionX),
                    (this._positionY =
                      t * (1 / this._zoom) - this._mousedownPositionY),
                    l.a.style(this.currentImg, {
          ...
          _calculateTouchZoom(t) {
            var e = Math.hypot(
                this._touchZoomPosition[1].pageX -
                  this._touchZoomPosition[0].pageX,
                this._touchZoomPosition[1].pageY -
                  this._touchZoomPosition[0].pageY
              ),
              n = Math.hypot(
              ...
              i = Math.abs(e - n);
            0.03 * t.view.screen.width < i &&
              (e <= n ? this.zoomIn() : this.zoomOut(),
              (this._touchZoomPosition = t.touches));
          }
          ...
          _onKeyup(t) {
            switch ((this._resetToolsToggler(), t.keyCode)) {
              case 39:
                a.f ? this.slide("left") : this.slide();
                break;
              case 37:
                a.f ? this.slide() : this.slide("left");
                break;
              case 27:
                this.close();
                break;
          ...
          _moveImg(t) {
            this._multitouch ||
              ...
              t !== this.currentImg ||
              this._images.length <= 1 ||
              (0 < (t = this._positionX - this._originalPositionX)
                ? a.f
                  ? this.slide()
                  : this.slide("left")
                : t < 0 && (a.f ? this.slide("left") : this.slide()));
          }
          _checkDoubleTap(t) {
            clearTimeout(this._doubleTapTimer);
            var e = new Date().getTime() - this._tapTime;
            0 < this._tapCounter && e < 500
          ...
          _setNewPositionOnZoomIn(t) {
            clearTimeout(this._zoomTimer),
              ...
              (this.currentImg.style.left = "".concat(this._positionX, "px")),
              (this.currentImg.style.top = "".concat(this._positionY, "px")),
          ...
          _hideTools() {
            l.a.style(this._galleryToolbar, {
              opacity: 0,
            }),
              l.a.style(this._leftArrowWrapper, {
                opacity: 0,
              }),
              l.a.style(this._rightArrowWrapper, {
                opacity: 0,
              });
          }
          _showTools() {
          ...
          _disableScroll() {
            l.a.addClass(document.body, "disabled-scroll"),
              document.documentElement.scrollHeight >
                document.documentElement.clientHeight &&
                l.a.addClass(document.body, "replace-scrollbar");
          }
          _enableScroll() {
            setTimeout(() => {
              l.a.removeClass(document.body, "disabled-scroll"),
                l.a.removeClass(document.body, "replace-scrollbar");
            }, 300);
          }
          _animationStart() {
            (this._animating = !0),
          ...
          async _triggerEvents(t, e) {
            i.b.trigger(this._element, "".concat(t, ".mdb.lightbox")),
              e &&
                (await setTimeout(() => {
                  i.b.trigger(this._element, "".concat(e, ".mdb.lightbox"));
                }, 505));
          }
          static getInstance(t) {
            return o.a.getData(t, c);
          ...
          static toggle() {
            return function (t) {
              var e = r.a.closest(t.target, ".".concat(u));
              (m.getInstance(e) || new m(e)).open(t);
            };
          }
          static jQueryInterface(n, i) {
            return this.each(function () {
        ...
        r.a.find(".".concat(u)).forEach((t) => new m(t)),
          i.b.on(document, "click", p, m.toggle()),
          Object(a.h)(() => {
            const t = Object(a.e)();
            if (t) {
              const e = t.fn[s];
              (t.fn[s] = m.jQueryInterface),
                (t.fn[s].Constructor = m),
                (t.fn[s].noConflict = () => ((t.fn[s] = e), m.jQueryInterface));
            }
          }),
          (e.a = m);
      },
